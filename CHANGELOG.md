...
Swift v.2.4.0 introduces Customer Center Dashboard, Sign in with Multiple Profiles, redesign of Favorites list and details and a range of bug fixes and accessibility improvements.
...
**On the Demo setup You can use these demo users for login: Salesrep, AccountAdmin, Demouser.**
...
### Favorites
Favorites let B2B buyers save the products they come back to regularly, so reordering is fast without having to search or browse each time. The Favorites list and detail design has been made more consistent: the layout is unified across all views, using the same style as orders and quotes. Swift provides two different design templates for the favorite list.
