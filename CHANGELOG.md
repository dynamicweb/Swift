...
DynamicWeb proudly presents Swift 1.22.0 (Q2-2023), which runs on DW version 9.15.8. This introduce  Stock and CSS Swift tool, The main headlines for this release are:
...
Swift has reimplemented how tracking works so it is possible to use both DynamicWeb's cookie manager and a third party cookie in an easier manner. 
