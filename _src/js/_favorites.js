  ...
  return {
    ...
    Update: async function (e) {
      ...
      var productButton = document.querySelector(
        "#FavoriteBtn_" + productId + variantId.replace(".", "")
      );
      ...
      if (clickedButton.getAttribute("data-command") != null) {
        ...
        if (command != null) {
          ...
          command =
						command == "remove" ? "removeproductfromfavoritelist" : command;
          form.querySelector('[name="FavoriteListId"]').value =
						clickedButton.getAttribute("data-list-id");
      ...
      clickedButton
        .closest("form")
        .querySelectorAll("[data-in-this-list]")
        .forEach(function (favoriteListButton) {
    ...
    Success: async function (
      ...
      var favoriteNotification = document.querySelector(
        "#favoriteNotificationToast"
      );
          ...
          if (
            ...
            if (data.Thumbnail != "") {
              ...
              document.querySelector(
                "#favoriteNotificationToast_Image"
              ).innerHTML = "";
              document
                .querySelector("#favoriteNotificationToast_Image")
                .appendChild(imageElement);
            }
            document.querySelector(
              "#favoriteNotificationToast_Text"
            ).innerHTML = data.ProductName;
            ...
            if (productButton) {
              ...
              clickedButton
                ...
                .forEach(function (favoriteListButton) {
                  if (
                    favoriteListButton.getAttribute("data-in-this-list") ==
										"True"
                  ) {
                    inAnyList = true;
                  }
              ...
              if (found == true) {
                //Check if anything changed in any of the favorite lists. If yes, change the icon on the product favorite button.
                const icon = productButton.querySelector(".favorite-icon");
                if (inAnyCurrentList != inAnyList) {
                  if (
                    icon
                      .querySelector(".not-in-list")
