...
const VariantSelector = (function () {
  return {
    init: function () {
      //Auto initialize
      document
        .querySelectorAll(".js-variant-selector")
        .forEach(function (variantSelector) {
    ...
    OptionClick: function (e) {
      ...
      var variantSelectorElement = clickedButton.closest(
        ".js-variant-selector"
      );
      clickedButton.blur();
    ...
    UpdateAllVariants: function (variantSelectorElement) {
      var combinations =
        variantSelectorElement.getAttribute("data-combinations");
    ...
    ToggleActiveState: function (clickedButton) {
      ...
      var inactiveClicked = isButton
        ? clickedButton.classList.contains("in-active")
        : clickedButton.selectedOptions[0].classList.contains("in-active");
      var isAlreadyActive = isButton
        ? clickedButton.classList.contains("active")
        : clickedButton.selectedOptions[0].classList.contains("active");

      //Allow clicking in-active options
      if (inactiveClicked) {
        clickedButton
          .closest(".js-variant-selector")
          .querySelectorAll(".js-variant-option")
          .forEach(function (option) {
    ...
    CheckSelectionComplete: function (variantSelectorElement, updatePage) {
      ...
      var totalGroups =
        variantSelectorElement.querySelectorAll(".js-variant-group").length;
      ...
      if (selectionCount == totalGroups && updatePage) {
        ...
        var variantIdElement =
          variantSelectorElement.querySelector("[name='variantid']");
            ...
            function (data) {
              ...
              if (
                htmlTempContainer
                  ...
                  .getAttribute("data-friendly-url")
              ) {
        ...
        const closestProduct =
          variantSelectorElement.closest(".js-product") !== null
            ? variantSelectorElement.closest(".js-product")
            : variantSelectorElement.closest("#content");
        const closestCartButton = closestProduct.querySelector(
