const ProductExport = (function () {
  ...
  return {
    ...
    AddRecipent: function (clickedButton) {
      ...
      const fieldToCopy = container
        .querySelector(".js-recipient-field")
        .cloneNode(true);

      clickedButton.setAttribute("disabled", "");
      fieldToCopy
        .querySelector(".js-recipient-add-btn")
        .removeAttribute("disabled");
      fieldToCopy.querySelector("input").id =
        "EmailRecipientExtra" + recipientsCount;
      fieldToCopy.querySelector("input").value = "";
      fieldToCopy.querySelector("label").for =
        "EmailRecipientExtra" + recipientsCount;
