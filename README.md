...
> [!NOTE]
> Swift 2.4.0 is running on a DW10.29.0 (R0) if you are not running a DW10.29.0 (R0), you can use (https://github.com/dynamicweb/Swift/releases#release-v2.3.0 "Swift 2.3.0")
